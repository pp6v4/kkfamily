  ...
  imports: [
    ConfigModule.forRoot({
      ...
      validationSchema: Joi.object({
        ...
        MEDIA_DRIVER: Joi.string().valid('disabled', 'memory', 'cos', 'mounted').default('disabled'),
        MEDIA_MOUNT_ROOT: Joi.string().when('MEDIA_DRIVER', { is: 'mounted', then: Joi.required(), otherwise: Joi.allow('') }),
